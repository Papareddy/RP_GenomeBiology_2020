...
## Small RNA analysis
Nextflow pipe line to analysed small RNA high throutput data sets.
...
* Default setings are as described in the mauscripts but parameters can bethats changes according to the users' wish (see sRNA.nf parameters section) ; *for example changing input file path, output file path and desired 3 prime adaptor sequences to be trimmed are as follows*<br/>
